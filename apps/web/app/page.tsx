...
export default function Page() {
  ...
  const STORE_URL = useMemo(() => {
    return process.env.NEXT_PUBLIC_STORE_URL || DEFAULT_STORE_URL;
  }, []);
  ...
  // Tarjeta "beneficio" estilo Streamlit
    ...
    <div style={shell}>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 18, display: "grid", gap: 10, fontWeight: 800 }}>
              <div style={{ padding: "10px 10px", borderRadius: 12, background: "rgba(255,255,255,0.12)" }}>
                Mi Perfil
              </div>
              <div style={{ padding: "10px 10px", borderRadius: 12, background: "rgba(255,255,255,0.12)" }}>
                Facturas
      ...
      <div style={container}>
        ...
        <section style={{ ...contentCard, marginTop: 18 }}>
          ...
          {/* Detalle operativo (para demo interna) */}
          <div
            style={{
              marginTop: 14,
              paddingTop: 12,
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
              ...
              <span>
                {me ? `${fmt(me.purchaseAvailableOfficial)} ${me.currency}` : "—"}
              </span>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
              ...
              <span>
                {me ? `${fmt(me.purchaseAvailableReserved)} ${me.currency}` : "—"}
              </span>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
              ...
              <span>
                {me ? `${fmt(me.purchaseAvailable)} ${me.currency}` : "—"}
              </span>
            </div>
            ...
            <div style={{ marginTop: 8, display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <button
                ...
                title="Muestra/oculta panel técnico"
              >
          ...
          <section style={contentCard}>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 12, flexWrap: "wrap" }}>
              <button
                ...
                title="Llama /v1/me/purchase/financed"
              >
              ...
              <button
                ...
                disabled={actionLoading !== null}
                title="Llama /v1/me/orders/reconcile"
              >
